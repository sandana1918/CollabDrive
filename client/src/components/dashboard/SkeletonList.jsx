export const SkeletonList = ({ rows = 6 }) => (
  <div className="overflow-hidden rounded-[24px] border border-[#e4ebf4] bg-white">
    {Array.from({ length: rows }).map((_, index) => (
      <div key={index} className="grid min-h-[72px] grid-cols-[48px_minmax(280px,1.9fr)_minmax(150px,0.8fr)_minmax(132px,0.74fr)_minmax(132px,0.74fr)_minmax(132px,0.75fr)_minmax(108px,0.45fr)_68px] items-center border-t border-[#eee2e8] px-4 first:border-t-0">
